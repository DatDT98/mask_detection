...
# from services.core_services.tracking_service import init_tracker
...
def detect(model, im0s, image_size, iou_thres, conf_thres, device):
    ...
    return labels, t2, bounding_boxes, confidences, response_bounding_boxes